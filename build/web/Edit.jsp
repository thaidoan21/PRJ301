<%-- 
    Document   : Buy
    Created on : May 25, 2021, 11:06:29 PM
    Author     : ADMIN
--%>
...
<%-- 
    Document   : Manager2.jsp
    Created on : Mar 16, 2021, 4:18:55 PM
    Author     : ADMIN
--%>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <form action="edit" method="post">
                            ...
                            <div class="modal-body">	
                                <div class="form-group">
                                    <label>ID</label>
                                    <input type="text"  class="form-control" name="pid" value="${product.pid}" readonly>
                            </div>
                            <div class="form-group">
                                <label>Name</label>
